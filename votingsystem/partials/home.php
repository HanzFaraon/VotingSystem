...
<html lang="en">
  ...
  <div class="container-fluid">
	...
	<div class="container">
        ...
        <label class="radio-label"><img src="https://png.pngtree.com/png-vector/20220807/ourmid/pngtree-man-avatar-wearing-gray-suit-png-image_6102786.png" class="img-thumbnail" alt="..."><?php echo $userdata['id'].' '.$userdata['firstname'].' '.$userdata['lastname']; ?></label>
        </div>
        <div class="form-check border2">
        <input class="radio-input" type="radio" name="test" value="yes" />
